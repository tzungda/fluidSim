...
vector3 grid3::cellCenterPosition(size_t i, size_t j, size_t k) const
{
    ...
    return vector3(o.x + ((FloatType)i + (FloatType)0.5) * h.x, o.y + ((FloatType)j + (FloatType)0.5) * h.y, o.z + ((FloatType)k + (FloatType)0.5) * h.z);
}
...
grid3::DataPositionFunc grid3::cellCenterPosition() const
{
    ...
    return [h, o](size_t i, size_t j, size_t k) {
        return o + h * vector3((FloatType)i + (FloatType)0.5, (FloatType)j + (FloatType)0.5, (FloatType)k + (FloatType)0.5);
    };
}
